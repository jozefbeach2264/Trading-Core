...
class MarketState:
    def __init__(self, symbol: str, config: Config):
        ...
        # Event to signal when initial data fetch is complete
    ...
    async def update_from_ws_books(self, data: dict):
        try:
            # The verbose log of the entire raw data packet has been removed from here.
            ...
            logger.error("Error processing 'books' data", extra={"error": str(e)}, exc_info=True)
    ...
    async def update_from_ws_agg_trade(self, data: dict):
        try:
            ...
            logger.error("Error processing 'trades' data or momentum", extra={"error": str(e)}, exc_info=True)
    ...
    async def update_account(self, account_data: dict):
        try:
            ...
            logger.error("Error parsing account balance data", extra={"error": str(e)}, exc_info=True)
    ...
    async def update_order(self, order_data: dict):
        try:
            ...
            logger.error("Error parsing position data", extra={"error": str(e)}, exc_info=True)
