...
class Config:
    def __init__(self):
        ...
        self.tlm_poll_interval_seconds: int = int(os.getenv("TLM_POLL_INTERVAL_SECONDS", "1"))
        ...
        self.max_liquidation_threshold: float = float(os.getenv('MAX_LIQUIDATION_THRESHOLD', '3.75'))
        ...
        self.low_volume_min_threshold: float = float(os.getenv('LOW_VOLUME_MIN_THRESHOLD', '2500'))
        ...
        # File & Log Paths
        self.log_file_path: str = os.getenv("LOG_FILE_PATH", "./logs/system/system.log")
        self.simulation_state_file_path: str = os.getenv("SIMULATION_STATE_FILE_PATH", "./logs/system/simulation_state.json")
        self.failed_signals_path: str = os.getenv("FAILED_SIGNALS_PATH", "./logs/system/failed_signals.json")
        ...
        self.ai_strategy_log_path: str = os.getenv("AI_STRATEGY_LOG_PATH", "./logs/system/ai_strategy.log")
